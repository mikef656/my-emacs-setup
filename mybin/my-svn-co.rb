...
# Note to self use file.join to make pats easier to create
# It manages the slashes well.
# if you pass an argument already ending with / (which is quite often when 
# working with paths), you won't have two slashes in the result
