...
#
# Even better make this free of dependance on a working copy.  The bit file
# in the tag is really irritating.
#
...
#
#change this to get the info from the tag rather than from the wc
#
