...
class Paddle:
    def __init__(self,canvas,color):
      ...
      self.i = 0
      #------------------------------------------------------------------------
      # Add this line to initially put text on the screen and get a handle to it
      #------------------------------------------------------------------------
      self.p_id = canvas.create_text(100,100,text=str(0),font=('Courier',10))
...
while 1:
    ...
    #------------------------------------------------------------------------    
    canvas.itemconfigure(paddle.p_id,text=str(paddle.i),font=('Courier',20),)
    time.sleep(0.1)
