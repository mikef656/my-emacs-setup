#!/usr/bin/python3
# based on chapter 12 of Python for Kids page180 "Displaying Text"
from tkinter import *
tk = Tk()
canvas = Canvas(tk, width=400, height=400)
canvas.pack()
canvas.create_text(150,100,text="There one was a man from Toulouse,")
canvas.create_text(130,120,text="Who rode around on his moose.,",fill="red")
