...
Includes cvs, font-lock, gnus, message, sgml, widget"
  ...
  (color-theme-install
   '(color-theme-aalto-light
    ...
    (custom-group-tag ((t (:bold t :foreground "blue" :weight bold :height 1.3))))
    (custom-group-tag-face-1 ((t (:bold t :family "red" :foreground "red" :underline t :weight bold :height 1.2))))
    (custom-invalid-face ((t (:background "red" :foreground "yellow"))))
    (custom-modified-face ((t (:background "blue" :foreground "white"))))
    (custom-rogue-face ((t (:background "black" :foreground "pink"))))
    (custom-saved-face ((t (:underline t))))
