...
(defun color-theme-zenburn ()
  ...
  (color-theme-install
   `(color-theme-zenburn
     ...
     ;; show-paren
     ;; (show-paren-mismatch ((t (:foreground ,zenburn-red-3 :weight extra-bold))))
     ;; (show-paren-match ((t (:foreground ,zenburn-blue-1 :weight extra-bold))))
     ;mtf did not look correct as written I think the face name was wrong
     (show-paren-mismatch-face ((t (:foreground ,zenburn-red-3 :weight extra-bold))))
     (show-paren-match-face ((t (:foreground ,zenburn-blue-1 :weight extra-bold))))
