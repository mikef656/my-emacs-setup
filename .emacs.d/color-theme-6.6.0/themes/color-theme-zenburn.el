...
(defvar zenburn-fg-1 "#656555") ;imported
  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
     ...
     '(mode-line ((t 
                     (:foreground "#acbc90" :background "#1e2320" :box (:color "#1e2320" :line-width 2))
                     )
                  )
     )
     ...
     ;MTf
     ;'(highlight ((t (:background "gray50" :underline t))))
     ;'(highlight ((t (:background "#348608690000" :underline t))));ic
     ;'(highlight ((t (:background "#451700143197" :underline t))));ic
     ;'(highlight ((t (:background "#52520000295C" :underline t))));ic
     ;'(highlight ((t (:background "#464646" :underline t)))) ;zen sub (gray)
     ;'(highlight ((t (:background "#332323" :underline t))));zen alt (brown-red)
     ;'(highlight ((t (:background "#2e3330" :underline t))));zen (greenish)
     ;'(highlight ((t (:background "#282828" :underline t)))) ;zen bgd -1 (black like sr modeline
     '(highlight ((t (:background "#4f4f4f" :underline t))));zen bgd +1 gray close to zen bgd
     ;'(highlight ((t (:background "#5f5f5f" :underline t))));zen bgd +2 (like the +1)
     ;
   ...
   `(org-column-title ((t (:background ,zenburn-bg-1 :underline t :weight bold))))
    ...
    ;; rainbow-delimiters from:
    ;emacs-fu.blogspot.com/2011/05/toward-balanced-and-colorful-delimiters.html
    `(rainbow-delimiters-depth-1-face ((t (:foreground ,zenburn-yellow))))
    `(rainbow-delimiters-depth-2-face ((t (:foreground ,zenburn-cyan))))
    `(rainbow-delimiters-depth-3-face ((t (:foreground ,zenburn-red+1))))
    `(rainbow-delimiters-depth-4-face ((t (:foreground ,zenburn-blue+1))))
...
(message "MTF Reached bottom of zenburn OK")
