...
(defun ack-run (directory regexp &rest arguments)
  ...
  (let ((buffer (get-buffer-create ack-buffer-name))
    ...
    (setq ack-process
          ...
          (apply 'start-process "ack" buffer "c:/Users/family/appdata/roaming/mybin/ack.pl" arguments)) 
...
(defun ack-version-string ()
 (interactive)
  ...
  (with-temp-buffer
    ...
    ;(call-process "c:/Users/family/appdata/roaming/mybin/ack.pl" nil t nil)
    ;(call-process "pwd" nil t nil)/cygdrive/c/Users/family/AppData/Roaming/.emacs.d/full-ack 
    (goto-char (point-min))
    (re-search-forward " +")
